...
import {  HoverProvider, IStandaloneEditorConstructionOptions } from "./type"

let registerHoverProvider: monaco.IDisposable | undefined

export function handleHoverProvider(properties: IStandaloneEditorConstructionOptions,  hoverProviders: HoverProvider[] = []) {
